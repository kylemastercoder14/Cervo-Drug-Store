      ...
      <div className="w-full xl:px-60 px-4 py-8">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-[16px]">Microbiology & Histopathology</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mt-2">
                Advanced bacterial identification, staining techniques, and tissue analysis
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="text-2xl">About Microbiology & Histopathology</CardTitle>
            <CardDescription className="text-base">
              Microbiology involves the study of microorganisms like bacteria, fungi, and viruses,
              while histopathology examines tissue samples for disease. Our laboratory provides
              comprehensive microbiological and histopathological services including gram staining,
              culture analysis, and cytological examinations.
            </CardDescription>
          </CardHeader>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Specialized microbiological and histopathological testing services
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-6 border border-blue-200">
          ...
          <p className="text-gray-700 mb-4">
            ...
            our microbiology and histopathology services.
          </p>
