  ...
  return (
    <div className="flex relative min-h-screen w-full flex-col">
      ...
      <div className="px-4 xl:px-60 py-5 mt-5">
        ...
        <h1 className="font-semibold text-4xl mb-5">Privacy Policy</h1>
        ...
        <h2 className="mt-5">Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Cervo Drug Store and Medical Clinic.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Cervo Drug Store and Medical
              Clinic, accessible from{" "}
              <a
                href="https://cervo-drug-store.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://cervo-drug-store.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="mt-5">Use of Your Personal Data</h2>
        ...
        <h2 className="mt-5">Retention of Your Personal Data</h2>
        <p>
        ...
        <h2 className="mt-5">Transfer of Your Personal Data</h2>
        <p>
        ...
        <h2 className="mt-5">Delete Your Personal Data</h2>
        <p>
        ...
        <h2 className="mt-5">Disclosure of Your Personal Data</h2>
        <p>
        ...
        <h2 className="mt-5">Security of Your Personal Data</h2>
        <p>
        ...
        <h2 className="mt-5">Links to Other Websites</h2>
        <p>
        ...
        <ul>
          <li>By email: cervowebsite@gmail.com</li>
        </ul>
      </div>
      <Footer />
    </div>
